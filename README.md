...
### Siya Bhasin | B.Tech CSE | Amity University, Noida | 2026
...
│
└── Final-Project_Siya_Bhasin/      # Lead Scoring Model — X Education
    ├── Lead_Scoring_Notebook.ipynb
    ├── app.py
...
### What's Built
- **ML Pipeline** — EDA → Preprocessing → Feature Selection → 3 Models → Ensemble Scoring
- **Models** — Logistic Regression + Random Forest + Gradient Boosting (AUC: **0.961**)
- **Streamlit CRM App** — Interactive dashboard with Executive View, Sales Lead List, and Live Predictor

### App Screenshots

**📊 Executive Dashboard**
![Executive Dashboard](Final-Project_Siya_Bhasin/Streamlit%20App%20Images/Executive%20Dashboard.PNG)

**📋 Sales Lead List**
![Sales Lead List](Final-Project_Siya_Bhasin/Streamlit%20App%20Images/Sales%20Lead%20List.PNG)

**🔮 Live Lead Predictor**
![Live Lead Predictor](Final-Project_Siya_Bhasin/Streamlit%20App%20Images/Live%20Lead%20Predictor.PNG)

📂 [View Final Project Folder](./Final-Project_Siya_Bhasin/) &nbsp;|&nbsp; 📊 [Dataset on Kaggle](https://www.kaggle.com/datasets/amritachatterjee09/lead-scoring-dataset)
